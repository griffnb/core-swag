...
```
// Before fix:
"WARNING: Package not found in map for github.com/griffnb/core-swag/testdata/core_models/billing_plan"
...
**Problem:** Package paths stored as short names like `"account"` instead of full module paths like `"github.com/griffnb/core-swag/testing/testdata/core_models/account"`.
...
**Verification:**
- ✅ Debug output shows: "Resolved package path for 'account' to 'github.com/griffnb/core-swag/testdata/core_models/account'"
